...
class BankOfferController extends Controller
{
     ...
     */
    public function index(BankOfferDatatable $bank_offer)
    {
    ...
    public function edit($id)
    {
        ...
        if($bank_offer){
            $bank        = Bank::where('id',$bank_offer->bank_id)->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate($rules);
        $credentials    = BankOffer::credentials($request,$bank_offer->bank_id,$bank_offer->logo_id);
