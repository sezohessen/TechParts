...
class SettingDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->editColumn('appName', '{{Str::limit($appName, 100)}}')
            ->editColumn('appName_ar', '{{Str::limit($appName_ar, 100)}}')
            ->addColumn('checkbox', 'dashboard.Setting.btn.checkbox')
            ->addColumn('action', 'dashboard.Setting.btn.action')
