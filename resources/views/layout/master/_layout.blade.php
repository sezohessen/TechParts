...
@else
    ...
    @include('layout.master._header-mobile')

    <div class="d-flex flex-column flex-root">
        <div class="d-flex flex-row flex-column-fluid page">

            @if(config('layout.aside.self.display'))
                @include('layout.master._aside')
            @endif

            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">

                @include('layout.master._header')
                ...
                <div class="content {{ Metronic::printClasses('content', false) }} d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    @include('layout.master._content')
                </div>

                @include('layout.master._footer')
            </div>
        </div>
    </div>
