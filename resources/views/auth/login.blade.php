            ...
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
                ...
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <a href="{{ url('/') }}" class="text-center mb-10">
                        <img src="{{ find_image(App\Models\Settings::first()->logo, 'img/settings/') }}" class="max-h-70px"
                            alt="" />
                    </a>
                    <!--end::Aside header-->
                    <!--begin::Aside title-->
                        ...
                        <div class="login-form login-signin">
                            ...
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">
                                    {{ __('Welcome to ') }}{{ Session::get('app_locale') == 'en' ? App\Models\Settings::first()->appName : App\Models\Settings::first()->appName_ar }}
                                </h3>
                                <span class="text-muted font-weight-bold font-size-h4">{{ __('New Here?') }}
                                    <a href="{{ url('/register') }}" id="kt_login_signup"
                                        class="text-primary font-weight-bolder">{{ __('Create an Account') }}</a></span>
                            </div>
