                    ...
                    <div class="login-form login-signup pt-11" style="display: block">
                        ...
                        <form class="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                @endphp
                                <select
                                    class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6 {{ $errors->has('country_id') ? 'is-invalid' : '' }}"
                            ...
                            <div class="form-group">
                                ...
                                <select id="provider"
                                    class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6 @error('provider') is-invalid @enderror"
                            ...
                            <div class="form-group d-flex flex-wrap flex-center pb-lg-0 pb-3">
                                <button type="submit"
                                    class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mx-4">@lang('Submit')</button>
                            </div>
                            <!--end::Form group-->
                        </form>
                        <!--end::Form-->
