        ...
        <div class="container">
            <div class="card-body">
                ...
                <div class="card-header flex-wrap py-3" style="min-height: 50px">
                    <a href="{{route("dashboard.seller.edit",['seller'=>$seller->id])}}" class="btn btn-primary font-weight-bolder">
                ...
                <hr>
                <h3 class="text-center text-danger border-bottom border-top pt-5 pb-5 border-danger mt-10 mb-10">
                    @lang("Seller's Parts")
                </h3>
                <div class="row">
                    <div class="table-responsive">
                        <div class="card-custom" style="width: 100%">
                            {!! Form::open(['id'=>'form_data','url'=>"dashboard/part/destroy/all",'method'=>'delete']) !!}
                                {!! $dataTable->table([
