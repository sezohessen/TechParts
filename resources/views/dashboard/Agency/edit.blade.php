    ...
    <div class="card card-custom">
        <div class="card-header">
            ...
            <div class="text-right">
                <a href="{{ route('dashboard.agency.index') }}" style="margin-top: 16px;"
        ...
        <form action="{{ route('dashboard.agency.update', $agency->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                required name="name" placeholder="@lang('Name(ENG)')" autofocus
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}"
                                required name="name_ar" placeholder="@lang('Name(AR)')"
                                value="{{ old('name_ar') ? old('name_ar') : $agency->name_ar }}" />
                            @error('name_ar')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <div class="radio-inline">
                                        <label class="radio">
                                            <input type="radio" name="center_type" value="0"
                                                {{ old('center_type') == '0' ? 'checked' : ($agency->center_type == 0 && old('center_type') == null ? 'checked' : '') }}
                                                required />
                                            <span></span>
                                            @lang('Agency')
                                        </label>
                                ...
                                <div class="form-group center_type" id="center_type1" style="display: none">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>@lang('Maintenance center type')<span
                                            ...
                                            <div class="radio-inline">
                                                ...
                                                @error('maintenance_type')
                                                    <div class="invalid-feedback">{{ $errors->first('maintenance_type') }}
                                                    </div>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="specialty_id">@lang('Maintenance center specialties') <span
                                                    class="text-danger">*</span></label>
                                            <select
                                                class="form-control select2 {{ $errors->has('specialty_id') ? 'is-invalid' : '' }}"
                                                id="kt_select2_2" name="specialty_id[]" multiple="multiple"
                                                style="width: 100%">
                                                @foreach ($specialties as $specialty)
                                                    @if (in_array($specialty->id, $agency_specialties_Main))
                                                        {{-- Check if Car maker in Selected Maintance Specializations list --}}
                                                        <option value="{{ $specialty->id }}" selected>
                                                            {{ $specialty->name }} - {{ $specialty->name_ar }}
                                                        </option>
                                                    @else
                                            ...
                                            @enderror
                                            <span class="form-text text-muted">@lang('You can choose more than one
                                                specialty')</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group center_type" id="center_type2" style="display: none">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="specialty_id_spare">@lang('Spare center specialties') <span
                                                    class="text-danger">*</span></label>
                                            <select
                                                class="form-control select2 {{ $errors->has('specialty_id_spare') ? 'is-invalid' : '' }}"
                                                id="kt_select2_4" name="specialty_id_spare[]" multiple="multiple"
                                                style="width: 100%">
                                                @foreach ($specialties as $specialty)
                                                    @if (in_array($specialty->id, $agency_specialties_Spare))
                                                        {{-- Check if Car maker in Selected Maintance Specializations list --}}
                                                        <option value="{{ $specialty->id }}" selected>
                                                            {{ $specialty->name }} - {{ $specialty->name_ar }}
                                                        </option>
                                            ...
                                            @error('specialty_id_spare')
                                                <div class="invalid-feedback">{{ $errors->first('specialty_id_spare') }}
                                                </div>
                                            @enderror
                                            <span class="form-text text-muted">@lang('You can choose more than one
                                                specialty')</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-list">
                                        <label
                                            class="checkbox  {{ $errors->has('payment_method') ? 'is-invalid' : '' }}">
                                            <input type="checkbox" name="payment_method[]" value="0" @if (is_array(old('payment_method')))
                                        ...
                                        <label class="checkbox ">
                                            <input type="checkbox" name="payment_method[]" value="1" @if (is_array(old('payment_method')))
                                        ...
                                        <label class="checkbox ">
                                            <input type="checkbox" name="payment_method[]" value="2" @if (is_array(old('payment_method')))
                                    ...
                                    <div class="radio-inline">
                                        <label class="radio">
                                            <input type="radio" name="car_status" value="0"
                                                {{ old('car_status') == '0' ? 'checked' : ($agency->car_status == 0 ? 'checked' : '') }}
                                                required />
                                            <span></span>
                                            @lang('New')
                                        </label>
                                    ...
                                    <div class="radio-inline">
                                        <label class="radio">
                                            <input type="radio" name="status" value="0"
                                                {{ old('status') == '0' ? 'checked' : ($agency->status == 0 ? 'checked' : '') }}
                                                required />
                                            <span></span>
                                            @lang('Normal')
                                        </label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('city_id') ? 'is-invalid' : '' }}" id="city"
                                ...
                                <option value="{{ $agency->city->id }}" selected>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control {{ $errors->has('messenger') ? 'is-invalid' : '' }}"
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="image-input image-input-empty image-input-outline" id="logo_id"
                                        style="background-image: url({{ find_image($agency->logo, 'img/agency/') }})">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <div class="image-input image-input-empty image-input-outline" id="img_id"
                                    style="background-image: url({{ find_image($agency->img, 'img/agency/') }})">
                                    <div class="image-input-wrapper"></div>
                                    <label
                                        class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                        data-action="change" data-toggle="tooltip" title=""
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="kt_select2_3">@lang('Car Maker Working in')<span
                                    class="text-danger">*</span></label>
                            <select class="form-control select2" id="kt_select2_3" name="CarMaker_id[]" multiple="multiple"
                                required>
                                @foreach ($car_makers as $car_maker)
                                    @if (in_array($car_maker->id, $SelectedCarMakers))
