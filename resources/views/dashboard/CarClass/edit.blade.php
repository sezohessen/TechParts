...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form action="{{route("dashboard.class.update",['class'=>$class])}}" method="POST">
            @csrf
            @method('PATCH')
            <div class="card-body">
                <!-- EN Form -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                             name="name"  placeholder="@lang('Name(ENG)')" value="{{ old('name') ? old('name') : $class->name}}" required autofocus  />
                            @error('name')
