...
<a href="{{ route('dashboard.trending-news.edit', ['trending_news' => $id]) }}" class="btn btn-md btn-success btn-icon mb-2"
    title="Edit details">
    <span class="svg-icon svg-icon-md">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
...
<div id="myModal{{ $id }}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route' => ['dashboard.trending-news.destroy', $id], 'method' => 'delete']) !!}
