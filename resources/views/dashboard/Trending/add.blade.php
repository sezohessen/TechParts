                        ...
                        <div class="form-group row">
                            ...
                            <div class=" col-lg-9 col-md-9 col-sm-12">
                                <div class="input-group date" >
                                    <input type="text" class="form-control" readonly name='day' value="{{old("day")}}"  placeholder="Select date" id="kt_datepicker_1"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class=" col-lg-9 col-md-9 col-sm-12">
                                <select class="form-control select2 {{ $errors->has('car_id') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($cars as $car)
                                       <option value="{{$car->id}}" >ID[{{$car->id}}]: {{$car->maker->name}} -{{$car->model->name}} </option>
                                    @endforeach
                                </select>
                                @error('car_id')
