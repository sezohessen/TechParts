...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4">
            <a href="{{ route('dashboard.users.index') }}" class="card card-custom bg-dark bg-hover-state-dark card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-5 mb-2 text-inverse-dark font-weight-bolder font-size-h3">{{ $users->count() }}</div>
        ...
        <div class="col-md-4">
            <a href="{{ route('dashboard.seller.index') }}" class="card card-custom bg-info bg-hover-state-info card-stretch gutter-b">
                <!--begin::Body-->
                <div class="card-body">
                    ...
                    <div class="mt-5 mb-2 text-inverse-info font-weight-bolder font-size-h3">{{ $sellers->count() }}</div>
            ...
            <a href="{{ route('dashboard.part.index') }}" class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-body">
                    <span class="svg-icon svg-icon-info svg-icon-3x ml-n1">
                        <i class="fas fa-tools fa-3x" style="color: #000000"></i>
                    </span>
                    <div class="mt-5 mb-2 text-inverse-white font-weight-bolder font-size-h3">{{ $parts->count() }}</div>
        ...
        <div class="col-md-4">
            <a href="{{ route('dashboard.contact.index') }}" class="card card-custom bg-primary bg-hover-state-primary card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-5 mb-2 text-inverse-primary font-weight-bolder font-size-h3">{{ $contacts->count() }}</div>
