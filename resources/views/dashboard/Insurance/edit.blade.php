...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form action="{{route("dashboard.insurance.update",$insurance->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="card-body">
                <!-- EN Form -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br>
                            <div class="image-input image-input-empty image-input-outline" id="logo" style="background-image: url({{find_image($insurance->img , 'img/insurance/') }})">
