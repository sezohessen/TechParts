...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form action="{{route("dashboard.body.store")}}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>@lang('Car Body Name') <span class="text-danger">*</span></label>
                            <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                             name="name"  placeholder="@lang('Car Body Name')" value="{{ old('name')}}" required autofocus  />
                            @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}"
                             name="name_ar"  placeholder="@lang('Car Body name_ar')" value="{{ old('name_ar')}}" required autofocus  />
                            @error('name_ar')
