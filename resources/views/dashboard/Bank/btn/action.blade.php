...
<a href="{{route("dashboard.bank.edit",['bank'=>$id])}}" class="btn btn-md btn-success btn-icon mb-2" title="Edit details">
    <span class="svg-icon svg-icon-md">
...
<div id="myModal{{ $id }}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route' => ['dashboard.bank.destroy', $id], 'method' => 'delete']) !!}
