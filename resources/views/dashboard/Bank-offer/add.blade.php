...
@section('content')
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form action="{{ route('dashboard.bank-offer.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <!-- EN Form -->
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="kt_select2_1">@lang('Select Bank Name') <span class="text-danger">*</span> </label>
                            <div class="form-group">
