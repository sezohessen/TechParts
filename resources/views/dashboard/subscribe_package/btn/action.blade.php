...
<a href="{{ route('dashboard.subscribe_packages.edit', ['subscribe_package' => $id]) }}" class="btn btn-md btn-success btn-icon mb-2"
    title="Edit details">
    <span class="svg-icon svg-icon-md">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
...
<div id="myModal{{ $id }}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['route' => ['dashboard.subscribe_packages.destroy', $id], 'method' => 'delete']) !!}
