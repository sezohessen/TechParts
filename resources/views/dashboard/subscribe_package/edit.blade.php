...
@section('content')
    ...
    <div class="card card-custom">
        ...
        <!--begin::Form-->
        <form action="{{route("dashboard.subscribe_packages.update",["subscribe_package"=>$subscribe_package->id])}}" method="POST">
            @csrf
            @method('PATCH')
            <div class="card-body">
                <!-- EN Form -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('period') ? 'is-invalid' : '' }}"
                             name="period" value="{{ old('period') ?? $subscribe_package->period }}" required placeholder="@lang('period')" autofocus/>
                            @error('period')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}"
                             name="price" value="{{ old('price') ?? $subscribe_package->price }}"required placeholder="@lang('price')"/>
                            @error('price')
                        ...
                        <div class="form-group ">
                            <div class=" col-lg-9 col-md-9 col-sm-12">
                                ...
                                <textarea   id="kt-ckeditor-1" name="description"   required  class="{{ $errors->has('description') ? ' is-invalid' : '' }}">
                                    {{old("description") ?? $subscribe_package->description}}
                                </textarea>
                                @error('description')
                        ...
                        <div class="form-group">
                            <div class=" col-lg-9 col-md-9 col-sm-12">
                                ...
                                <textarea   id="kt-ckeditor-2" name="description_ar"   required  class="{{ $errors->has('description_ar') ? ' is-invalid' : '' }}">
                                    {{old("description_ar") ?? $subscribe_package->description_ar}}
                                </textarea>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('currency_name') ? 'is-invalid' : '' }}"
                             name="currency_name"  value="{{ old('currency_name') ?? $subscribe_package->currency_name }}" required placeholder="@lang('Currency Name')"/>
                            @error('currency_name')
