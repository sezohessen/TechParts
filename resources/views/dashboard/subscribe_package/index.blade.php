...
@section('content')
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap py-3" style="min-height: 50px">
            <a href="{{ route('dashboard.subscribe_packages.create') }}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="container">
            <div class="row">
                <div class="card-custom" style="width: 100%;">
                    {!! Form::open(['id' => 'form_data', 'url' => 'dashboard/subscribe_packages/destroy/all', 'method' => 'delete'])
                    !!}
